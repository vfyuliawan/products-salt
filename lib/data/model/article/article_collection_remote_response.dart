...
@JsonSerializable()
class ArticleCollectionRemoteResponse implements ArticleCollectionRemoteResponseMapper {
  String? status;
  int? totalResult;
  List<ArticleRemoteResponse>? articles;

  ArticleCollectionRemoteResponse({this.status, this.totalResult, this.articles});

  factory ArticleCollectionRemoteResponse.fromJson(Map<String, dynamic> json) =>
      _$ArticleCollectionRemoteResponseFromJson(json);

  Map<String, dynamic> toJson() => _$ArticleCollectionRemoteResponseToJson(this);
